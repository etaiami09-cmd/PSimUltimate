...
#ifndef PORTABLE_FILE_DIALOGS_H
#define PORTABLE_FILE_DIALOGS_H

#if _WIN32
#ifndef WIN32_LEAN_AND_MEAN
#   define WIN32_LEAN_AND_MEAN 1
#endif
// Rename/suppress Win32 symbols that conflict with other libraries (e.g. raylib)
...
#undef ShowCursor
#undef Rectangle
#undef DrawText   // macro in wingdi.h
#undef LoadImage  // macro in winuser.h
